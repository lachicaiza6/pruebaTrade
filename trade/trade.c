...
void uso(programa) char *programa;
{
  fprintf(stderr,
...
double precio_accion(t) struct accion *t;
{
...
char *nombre_industria(t) struct accion *t;
{
...
char *nombre_compania(t) struct accion *t;
{
  char *cptr;
...
double precio_medio(array, longitud) struct accion **array;
int longitud;
{
  int contador;
  double suma = 0.0;
...
double tamanio_medio(array, longitud) struct accion **array;
int longitud;
